...
import com.madconch.running.base.widget.activity.BaseSimpleListActivity;
...
public abstract class SimpleListActivity<T> extends BaseSimpleListActivity implements MadPagingListHelper.IPagingListCallback<T> {
