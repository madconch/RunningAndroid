...
public class GridItemDecoration1 extends RecyclerView.ItemDecoration {
    ...
    public GridItemDecoration1 setVerticalDividerDrawable(Drawable verticalDividerDrawable) {
    ...
    public GridItemDecoration1 setHorizontalDividerDrawable(Drawable horizontalDividerDrawable) {
    ...
    public GridItemDecoration1 setShowTopDivider(boolean showTopDivider) {
    ...
    public GridItemDecoration1 setShowLeftDivider(boolean showLeftDivider) {
    ...
    public GridItemDecoration1 setShowRightDivider(boolean showRightDivider) {
    ...
    public GridItemDecoration1 setShowBottomDivider(boolean showBottomDivider) {
