package com.madconch.running.ui.loading;
...
public class MadLoadingHelper implements ILoadingHelper {
    ...
    public static synchronized MadLoadingHelper with(View view) {
        ...
        if (tag != null && tag instanceof MadLoadingHelper) {
            return (MadLoadingHelper) tag;
        } else {
            MadLoadingHelper loadingHelper = new MadLoadingHelper(view);
            ...
            btnRetry.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (retryListener != null) {
                        retryListener.onRetry(MadLoadingHelper.this);
                    }
                }
            });
        }
            ...
            btnLogin.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (loginListener != null) {
                        loginListener.login(MadLoadingHelper.this);
                    }
                }
            });
        }
